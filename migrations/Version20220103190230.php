 ...
 */
final class Version20220103190230 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE formation (id INT AUTO_INCREMENT NOT NULL, candidat_id INT DEFAULT NULL, level_id INT DEFAULT NULL, date DATE NOT NULL, title VARCHAR(100) NOT NULL, place VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, referent VARCHAR(100) NOT NULL, INDEX IDX_404021BF8D0EB82 (candidat_id), INDEX IDX_404021BF5FB14BA7 (level_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
