...
/**
 * @Route("/reinitialiser_lemotdepasse")
 */
class ResetPasswordController extends AbstractController
{
    ...
    public function request(Request $request, MailerInterface $mailer): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            return $this->processSendingPasswordResetEmail(
                $form->get('email')->getData(), /* @phpstan-ignore-line */
                $mailer
            );
        }
    ...
    public function reset(
        ...
        if (null === $token) {
            throw $this->createNotFoundException('Aucun token dans l\'URL.');
        }
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $user->setPassword($encodedPassword); /* @phpstan-ignore-line */
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address($address, 'CERHA'))
            /** @var string */
